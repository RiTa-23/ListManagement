        ...
        <div class="p-6 text-gray-900 dark:text-gray-100">
          ...
          <form method="POST" action="{{ route('members.update', $member) }}">
            ...
            <div class="mb-4">
              ...
              <input type="text" name="studentID" id="studentID" value="{{$member->studentID}}"
          ...
          <form method="POST" action="{{ route('members.destroy', $member) }}">
            ...
            @method('DELETE')
            <div align="right">
              <button type="submit" class="text-red-500 hover:text-red-700">メンバー削除</button>
            </div>
          </form>
        </div>
      </div>
